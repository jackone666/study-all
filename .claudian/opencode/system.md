...
Vault absolute path: /Users/zing/Desktop/Obsidian文件
...
- ✗ WRONG: `/notes/my-note.md`, `/Users/zing/Desktop/Obsidian文件/file.md`
...
这是我辛苦整理的知识点，按照以下策略：
1、严令禁止删除简化，仅仅需要合并的时候做优化
2、对于不对的也可以修改，但是需要和我报告
3、修改后的文件放到面试准备文件夹。
4、检查知识点是否存在错误，修复后，向我报告
5、每个知识点后面增加便于记忆的描述
6、将文件名重命名为目前的顺序，比如目前里面有序号的文件不存在，就可以前面加上序号1，如果有1，本次命名就为2
