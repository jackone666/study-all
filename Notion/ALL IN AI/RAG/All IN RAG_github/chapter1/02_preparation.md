...
1.  **访问 Deepseek 开放平台**
    ...
    ![Deepseek 平台首页](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_1.webp)
...
3.  **创建新的 API 密钥**
    ...
    ![创建新密钥按钮](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_2.webp)
...
4.  **保存 API Key**
    ...
    ![复制并保存密钥](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_3.webp)
...
2.  **创建新分支**
    ...
    ![创建新分支1](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_4.webp)

    ![创建新分支2](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_5.webp)

3.  **创建Codespaces**
    在项目页面的右上角，点击 `Code` 按钮，然后选择 `Codespaces` 选项卡。点击 `New codespace` 按钮，等待新的 Codespaces 环境创建成功。

    ![创建Codespaces](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_6.webp)

4.  **再次进入Codespaces**
    网页关闭后，找到刚才新建的存储库，点击红框框选内容即可重新进入 codespace 环境。

    ![再次进入Codespaces](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_7.webp)

5.  **额度设置**
    找到 GitHub 的账户设置中的 codespace 设置，挂起时间建议根据自己情况调整（时间过长会浪费额度，免费账号提供了单核120小时的额度）

    ![额度设置](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_8.webp)

### 2.2 python环境配置

进入 IDE 后先选择下方终端

![进入终端](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_9.webp)
...
3.  **创建应用**
    ...
    ![创建应用](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_10.webp)

4.  **再次进入**
    后续在[应用管理页面](https://cloudstudio.net/my-app)找到之前创建的应用，点击后选择右上角编写代码即可再次进入。

    ![再次进入应用](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_11.webp)

### 3.2 python环境配置

进入 IDE 后先选择右侧终端

![进入终端](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_12.webp)
...
3.  在 “系统属性” 对话框中，点击 “高级” 选项卡，然后点击下方的 “环境变量” 按钮。
    ...
    ![高级系统设置](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_13.webp)

4.  在 “环境变量” 对话框中，点击 “新建”（在 “用户变量” 部分下），然后输入以下信息：
    - 变量名：DEEPSEEK_API_KEY
    - 变量值：[你的 Deepseek API 密钥]

    ![高级系统设置](Notion/ALL%20IN%20AI/RAG/All%20IN%20RAG_github/chapter1/images/1_2_14.webp)
